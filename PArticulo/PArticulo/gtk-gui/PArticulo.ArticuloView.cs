...
namespace PArticulo
{
	public partial class ArticuloView
	{
		...
		protected virtual void Build ()
		{
			...
			this.saveAction = new global::Gtk.Action ("saveAction", global::Mono.Unix.Catalog.GetString ("saveAction"), null, "gtk-save");
			this.saveAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("saveAction");
			...
			this.UIManager.AddUiFromString ("<ui><toolbar name='barBotones'><toolitem name='saveAction' action='saveAction'/></toolbar></ui>");
